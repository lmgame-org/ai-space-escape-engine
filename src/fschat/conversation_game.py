...
class Conversation:
    ...
    roles: Tuple[str, str] = ("user", "assistant")
    # All messages. Can be a list of lists or tuples.
    messages: Optional[Union[List[Tuple[str, str]], Tuple[Tuple[str, str], ...]]] = None
    # --------------- gameplay related fields --------------- #
    all_questions: Optional[List[str]] = None
    # Game-related attributes
    game: Any = None
    game_secret: Any = None
    end_prefix: Optional[str] = None
    turn_limit_akinator: int = 20
    turn_limit_taboo: int = 5
    turn_limit_bluffing: int = 10
    turns: int = 0
    status: str = 'initialized'  # For Akinator game: 'initialized', 'in-game', 'terminated'
    # --------------- gameplay related fields --------------- #
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.turn_limit_akinator = turn_limit_akinator
        self.turn_limit_taboo = turn_limit_taboo
        self.turn_limit_bluffing = turn_limit_bluffing
        self.turns = turns
        self.status = status
        self.offset = offset
    ...
    def to_openai_api_messages(self, model_name=None):
        """Convert the conversation to OpenAI chat completion format."""
        if self.system_message == "" or (model_name and "o1" in model_name):
            ret = []
        else:
